...
export default function Dashboard() {
  ...
  useEffect(() => {
    async function fetchDashboard() {
      ...
      setError("");
      try {
        console.log("Fetching dashboard..."); // ho balla dashboard ayo
        const res = await api.get("/dashboard");
        console.log("Dashboard response:", res.data); // debug gareko ho hai response ko data sahit data ma chai stat auxa la sathi
        ...
        console.error("Dashboard error:", err); //debug gareko hai kinaki ya error k akyo ayi
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-6">
          ...
          ) : stats ? ( // Add null check for stats
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Card
                  ...
                  icon={
                    <FaUsers className="w-5 h-5 text-green-500 hover:text-red-600" />
                  }
                />
                <Card
                  ...
                  subtitle="New issues"
                  icon={
                    <FaCalendarAlt className="w-5 h-5 text-purple-500 hover:text-red-600" />
                  }
                />
                <Card
                  title="Overdue Books"
                  ...
                  icon={
                    <FaExclamationTriangle className="w-5 h-5 text-red-500 hover:text-blue-600" />
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Latest books issued to members
                  </p>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <QuickAction
                      label="Add New Book"
                      icon={<FaBook className="w-5 h-5 text-gray-400" />}
                    />
                    <QuickAction
                      label="Register Member"
                      icon={<FaUserPlus className="w-5 h-5 text-gray-400" />}
                    />
                    <QuickAction
                      label="Issue Book"
                      icon={<FaPlus className="w-5 h-5 text-gray-400" />}
                    />
                  </div>
                </div>
              </div>
