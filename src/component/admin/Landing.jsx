...
function Landing() {
    ...
    <>
      <div className="w-full shadow-md border-b px-6 py-4 bg-white flex justify-between items-center sticky top-0 z-50 font-sans">
        <div className="flex items-center space-x-3">
          <MdLocalLibrary className="text-5xl text-[#4AB5BB]" />
          <div>
        ...
        <button
          className="bg-[#4AB5BB] text-white px-5 py-2 rounded-lg hover:bg-green-600 transition-colors font-medium"
  ...
  <h2 className="text-5xl font-semibold text-[#4AB5BB] mt-2">
          Management System
        </h2>
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button
            className="bg-green-600 text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-[#4AB5BB] transition-colors"
            onClick={() => window.location.href = "/login"}
          >
            Get Started
          </button>
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-6">
          ...
          <button
            className="mt-8 bg-green-600 text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-[#4AB5BB] transition-colors"
            onClick={() => (window.location.href = "/login")}
          >
            Explore Now
          </button>
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-12 bg-gray-50 px-6 lg:px-16 py-20 font-sans">
        <div className="w-full lg:w-2/3">
          <h1 className="text-3xl lg:text-4xl font-bold text-[#4AB5BB]">
        ...
        <div className="w-full lg:w-1/3 bg-white p-8 text-center rounded-xl shadow-md">
          <h1 className="text-3xl font-bold text-[#4AB5BB]">500k+</h1>
          ...
          <button
            className="bg-[#4AB5BB] text-white px-5 py-2 rounded-lg mt-5 hover:bg-green-600 transition-colors font-medium"
            onClick={() => (window.location.href = "/login")}
          >
            Start Free Trial
          </button>
  ...
  <h1 className="text-4xl font-bold text-[#4AB5BB]">
        ...
        <button
          className="bg-green-600 text-white px-6 py-3 rounded-lg mt-6 hover:bg-[#4AB5BB] transition-colors font-medium"
          onClick={() => (window.location.href = "/login")}
        >
          Sign in to Continue
        </button>
...
function Card({ icon, title, subtitle }) {
  ...
  <div className="flex items-center justify-center w-12 h-12 bg-blue-100 text-[#4AB5BB] rounded-full mb-4">
        {icon}
      </div>
